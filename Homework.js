...
function whoIsBigger(i,b) {
  if (i >= b){
    return i
  } else {
    return b
  }}
  let numbers = whoIsBigger(3,20)
  console.log(numbers)
...
*/
print('EX-4')
let word1 = 'Monte Bianco' 
let word2 = false
function deleteOne(string, word2 ) {
 
  if (word2===true) {
  return  word1 = string.substring(1)
  }else {
  return word1 = string.substring(0, word1.length - 1)
  }}
